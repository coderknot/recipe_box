...
public class IngredientTest {
  ...
  public void all_returnsAllSavedIngredients_true() {
    Ingredient testIngredient1 = new Ingredient("chicken");
    testIngredient1.save();
    Ingredient testIngredient2 = new Ingredient("beef");
    testIngredient2.save();
    assertEquals(testIngredient1.getId(), Ingredient.find(testIngredient1.getId()).getId());
    assertEquals(testIngredient2.getId(), Ingredient.find(testIngredient2.getId()).getId());
  }
